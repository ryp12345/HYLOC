    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
          <div className="text-gray-500 text-sm font-semibold mb-2">Leave Balance</div>
          <div className="text-3xl font-bold text-gray-800">--</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
          <div className="text-gray-500 text-sm font-semibold mb-2">Days Present</div>
          <div className="text-3xl font-bold text-gray-800">--</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-orange-500">
          <div className="text-gray-500 text-sm font-semibold mb-2">Days Absent</div>
          <div className="text-3xl font-bold text-gray-800">--</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
          <div className="text-gray-500 text-sm font-semibold mb-2">On Leave</div>
          <div className="text-3xl font-bold text-gray-800">--</div>
        </div>
      </div>
